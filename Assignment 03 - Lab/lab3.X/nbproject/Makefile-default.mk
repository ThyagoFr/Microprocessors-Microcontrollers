...
${OBJECTDIR}/lab3.o: lab3.asm  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/lab3.o 
	@${FIXDEPS} dummy.d -e "${OBJECTDIR}/lab3.err" $(SILENT) -c ${MP_AS} $(MP_EXTRA_AS_PRE) -d__DEBUG -d__MPLAB_DEBUGGER_PK3=1 -q -p$(MP_PROCESSOR_OPTION)  -l\"${OBJECTDIR}/lab3.lst\" -e\"${OBJECTDIR}/lab3.err\" $(ASM_OPTIONS)    -o\"${OBJECTDIR}/lab3.o\" \"lab3.asm\" 
